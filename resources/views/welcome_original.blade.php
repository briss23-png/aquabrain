    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 15px;">
        ...
        <section id="realisations" class="container animate-on-scroll">
            ...
            <p style="text-align: center; max-width: 800px; margin: 0 auto 20px;">
                Nous accompagnons des particuliers, des institutions, entreprises et projets aquacoles en Afrique à travers des études, missions terrain et appuis techniques à fort impact.
            </p>
